...
if (strlen($_SESSION["alogin"]) == 0) {
    ...
    if (isset($_POST["return"])) {
        ...
        $rstatus = 1;
        $sql =
        "update issuedbookdetails set fine=:fine,ReturnStatus=:rstatus where id=:rid";
