...
else
{
    ...
    if (isset($_POST['add']))
    {
        ...
        $isbn = $_POST['isbn'];
        $price = $_POST['price'];
        $sql = "INSERT INTO books(BookName,GenreId,AuthorId,ISBNNumber,BookPrice) VALUES(:bookname,:genre,:author,:isbn,:price)";
                                ...
                                <select class="form-control" name="genre" required="required">
                                    ...
                                    if ($query->rowCount() > 0)
                                    {
                                        foreach ($results as $result)
                                            { ?>  
                                                <option value="<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->Genre); ?></option>
                                                <?php
                                            }
                                        } ?> 
                                    </select>
