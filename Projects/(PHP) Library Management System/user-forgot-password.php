  ...
  //code for captach verification
    if ($_POST["vercode"] != $_SESSION["vercode"] OR $_SESSION["vercode"]=='')  {
        ...
        if($query -> rowCount() > 0)
        {
            ...
            $chngpwd1->execute();
            echo "<script>alert('Your password was succesfully updated!');</script>";
        }
        else {
            echo "<script>alert('Either Email id or Mobile number is invalid!');</script>"; 
        }
    }
}
?>
